...
plot(data_specific_dates$Global_active_power ~ data_specific_dates$datetime, type = "l", col = "black", ylab = "Global Active Power", xlab = "")

plot(data_specific_dates$Voltage ~ data_specific_dates$datetime, type = "l", col = "black", ylab = "Voltage", xlab = "datetime")
...
plot(data_specific_dates$Global_reactive_power ~ data_specific_dates$datetime, type = "l", col = "black", ylab = "Global_reactive_power", xlab = "datetime")
